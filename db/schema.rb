...
ActiveRecord::Schema.define(version: 20150529225004) do
  ...
  add_index "tags_tools", ["tag_id"], name: "index_tags_tools_on_tag_id"
  add_index "tags_tools", ["tool_id"], name: "index_tags_tools_on_tool_id"
  ...
  add_index "tools_users", ["tool_id"], name: "index_tools_users_on_tool_id"
  add_index "tools_users", ["user_id"], name: "index_tools_users_on_user_id"
  ...
  add_index "tvotes", ["tool_id"], name: "index_tvotes_on_tool_id"
  add_index "tvotes", ["user_id"], name: "index_tvotes_on_user_id"
