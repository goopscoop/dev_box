...
(function (window, undefined) {
  ...
  EpicEditor.prototype.load = function (callback) {
    ...
    // ########################################################################
    // ATTEMPT TO ADD A CLASS TO HTML
    // ########################################################################

      self.element.className="epiceditorclass";

    // ########################################################################
    // END ATTEMPT TO ADD A CLASS TO HTML
    // ########################################################################
    ...
    // #######################################################################
    // ATTEMPT TO ADD A CLASS TO THE BODY
    // #######################################################################
    // self.iframe.body.className="epiceditorclass";
    this.editorIframeDocument.body.style.padding = "10px";
    self.editor.className="epiceditorclass";
    // #######################################################################
    // END ATTEMPT TO ADD A CLASS TO THE BODY
    // #######################################################################
